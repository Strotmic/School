...
public class EducationalProduction : Production
{
    ...
    public EducationalProduction(string name, string date, double price, string description, string teachingMaterial)
    {
        Name = name;
        Date = date;
        Price = price;
...
public class GuestPerformance : Production
{
    ...
    public GuestPerformance(string name, string date, double price, string description, string association)
    {
        Name = name;
        Date = date;
        Price = price;
...
public class TheatreProduction : Production
{
    ...
    public TheatreProduction(string name, string date, double price, string description, string director, string genre)
    {
        Name = name;
        Date = date;
        Price = price;
